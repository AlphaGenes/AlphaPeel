...
python ../../tinyPeel.py -genotypes test1/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test2/genotypes.txt \
...
rm -rf test3/outputs
mkdir test3/outputs
python ../../tinyPeel.py -genotypes test3/genotypes.txt \
...
for nind in 1 2 3 4; do
  ...
  python ../../tinyPeel.py -genotypes test3b/genotypes-$nind.txt \
                            -runType multi \
                            -calling_threshold .1 \
                            -binary_call_files \
  ...
  python ../../tinyPeel.py -bfile test3b/outputs/output.$nind.called.0.1 \
                            -runType multi \
                            -calling_threshold .1 \
                            -binary_call_files \
...
python ../../tinyPeel.py -genotypes test3c/genotypes.txt \
                          -runType multi \
                          -calling_threshold .9 \
                          -binary_call_files \
...
python ../../tinyPeel.py -bfile test3c/outputs/output.called.0.9 \
                          -runType multi \
                          -calling_threshold .9 \
...
for method in id pedigree genotypes sequence; do
    python ../../tinyPeel.py -genotypes test4/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test5/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test6/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test7/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test7b/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test7c/genotypes.txt \
...
python ../../tinyPeel.py -genotypes test8/genotypes.txt \
